...
# Complete training pipeline for Custom Implementation
...
HF_CACHE_PATH="${HOME}/.cache/huggingface/hub/datasets--t2ance--APE-data/snapshots"
...
echo "=== Custom Implementation Training Pipeline ==="
echo "Configuration:"
echo "  Device: $DEVICE"
echo "  Dataset: $SUBSET"
...
if [ "$DOWNLOAD_DATA" = true ]; then
    echo "Step 0/5: Downloading APE-data from HuggingFace..."
...
python scripts/train_latent_diffusion.py \
    ...
    --predict-residual \
    --use-cfg \
    --output-dir ./checkpoints/latent_diffusion_ape
